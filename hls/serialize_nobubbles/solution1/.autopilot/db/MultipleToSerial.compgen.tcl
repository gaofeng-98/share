...
set ID 8
set hasByteEnable 0
set MemName MultipleToSerial_tmp_elements_RAM_AUTO_1R1W_memcore
...
set MemName MultipleToSerial_tmp_elements_RAM_AUTO_1R1W
...
# FIFO definition: 
set ID 9
set FifoName MultipleToSerial_fifo_w32_d2_S
set InstName tmp_elements_num_loc_channel_U
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_r_TDATA { I 288 vector } input_r_TVALID { I 1 bit } input_r_TREADY { O 1 bit } } \
} "
} else {
