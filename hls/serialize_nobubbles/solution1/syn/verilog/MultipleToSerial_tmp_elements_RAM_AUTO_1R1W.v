...
module MultipleToSerial_tmp_elements_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 32,
    AddressRange = 32,
    AddressWidth = 3,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        MultipleToSerial_tmp_elements_RAM_AUTO_1R1W_memcore MultipleToSerial_tmp_elements_RAM_AUTO_1R1W_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
