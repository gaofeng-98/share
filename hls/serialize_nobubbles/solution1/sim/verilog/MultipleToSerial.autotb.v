...
`define AUTOTB_DUT      MultipleToSerial
`define AUTOTB_DUT_INST AESL_inst_MultipleToSerial
`define AUTOTB_TOP      apatb_MultipleToSerial_top
`define AUTOTB_LAT_RESULT_FILE "MultipleToSerial.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "MultipleToSerial.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_MultipleToSerial_top
...
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.MultipleToSerial.autotvin_input_r.dat"
`define AUTOTB_TVOUT_output_r  "../tv/cdatafile/c.MultipleToSerial.autotvout_output_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "../tv/rtldatafile/rtl.MultipleToSerial.autotvout_output_r.dat"
module `AUTOTB_TOP;
