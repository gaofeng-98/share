...
`define TV_IN_input_r_TDATA "../tv/cdatafile/c.MultipleToSerial.autotvin_input_r.dat"
...
module AESL_axi_s_input_r (
    input clk,
    input reset,
    output [288 - 1:0] TRAN_input_r_TDATA,
    ...
    reg [288 - 1:0] input_r_TDATA_write_data;
    reg input_r_TDATA_read_en;
    wire [288 - 1:0] input_r_TDATA_read_data;
    
    fifo #(1, 288) fifo_input_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    function [599:0] read_token(input integer fp);
        integer ret;
        begin
            read_token = "";
                    ret = 0;
    ...
    function [599:0] rm_0x(input [599:0] token);
        reg [599:0] token_tmp;
        integer i;
        begin
            token_tmp = "";
