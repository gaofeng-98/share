...
if {[file isfile MultipleToSerial.autotvin.dat]} {
	file delete -force MultipleToSerial.autotvin.dat
}

if {[file isfile MultipleToSerial.autotvout.dat]} {
	file delete -force MultipleToSerial.autotvout.dat
}
