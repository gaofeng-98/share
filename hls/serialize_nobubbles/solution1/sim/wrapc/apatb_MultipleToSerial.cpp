...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.MultipleToSerial.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.MultipleToSerial.autotvout_input_r.dat"
...
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.MultipleToSerial.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.MultipleToSerial.autotvout_output_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_input_r "../tv/rtldatafile/rtl.MultipleToSerial.autotvout_input_r.dat"
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.MultipleToSerial.autotvout_output_r.dat"
...
extern "C" void MultipleToSerial_hw_stub_wrapper(volatile void *, volatile void *);

extern "C" void apatb_MultipleToSerial_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
long __xlx_apatb_param_input_r_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_input_r_stream_buf_final_size; ++i)((hls::stream<__cosim_s36__>*)__xlx_apatb_param_input_r)->read();
long __xlx_apatb_param_output_r_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > output_r_pc_buffer;
          int i = 0;
...
((char*)&xlx_stream_elt)[0*4+0] = output_r_pc_buffer[j].range(7, 0).to_int64();
((char*)&xlx_stream_elt)[0*4+1] = output_r_pc_buffer[j].range(15, 8).to_int64();
((char*)&xlx_stream_elt)[0*4+2] = output_r_pc_buffer[j].range(23, 16).to_int64();
((char*)&xlx_stream_elt)[0*4+3] = output_r_pc_buffer[j].range(31, 24).to_int64();
((hls::stream<__cosim_s4__>*)__xlx_apatb_param_output_r)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
...
std::vector<__cosim_s36__> __xlx_apatb_param_input_r_stream_buf;
{
  while (!((hls::stream<__cosim_s36__>*)__xlx_apatb_param_input_r)->empty())
    __xlx_apatb_param_input_r_stream_buf.push_back(((hls::stream<__cosim_s36__>*)__xlx_apatb_param_input_r)->read());
  for (int i = 0; i < __xlx_apatb_param_input_r_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s36__>*)__xlx_apatb_param_input_r)->write(__xlx_apatb_param_input_r_stream_buf[i]);
  }
long __xlx_apatb_param_input_r_stream_buf_size = ((hls::stream<__cosim_s36__>*)__xlx_apatb_param_input_r)->size();
std::vector<__cosim_s4__> __xlx_apatb_param_output_r_stream_buf;
long __xlx_apatb_param_output_r_stream_buf_size = ((hls::stream<__cosim_s4__>*)__xlx_apatb_param_output_r)->size();
CodeState = CALL_C_DUT;
MultipleToSerial_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_input_r_stream_buf_final_size = __xlx_apatb_param_input_r_stream_buf_size - ((hls::stream<__cosim_s36__>*)__xlx_apatb_param_input_r)->size();
...
long __xlx_apatb_param_output_r_stream_buf_final_size = ((hls::stream<__cosim_s4__>*)__xlx_apatb_param_output_r)->size() - __xlx_apatb_param_output_r_stream_buf_size;
{
  while (!((hls::stream<__cosim_s4__>*)__xlx_apatb_param_output_r)->empty())
    __xlx_apatb_param_output_r_stream_buf.push_back(((hls::stream<__cosim_s4__>*)__xlx_apatb_param_output_r)->read());
  for (int i = 0; i < __xlx_apatb_param_output_r_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s4__>*)__xlx_apatb_param_output_r)->write(__xlx_apatb_param_output_r_stream_buf[i]);
  }
