...
############################################################
set project_folder_name "serialize_nobubbles"
open_project ${project_folder_name}
set_top MultipleToSerial

set XF_PROJ_ROOT "/group/techsup/gaofengz/hls_work/${project_folder_name}" 
...
add_files ${project_folder_name}/questionare.cpp -cflags "-I../libs/Vitis_Libraries/vision/L1/include" -csimflags "-I../libs/Vitis_Libraries/vision/L1/include  -std=c++0x"
# add_files -tb ${project_folder_name}/tb_questionare.cpp -cflags "-I../libs/Vitis_Libraries/vision/L1/include ${OPENCV_INC_FLAGS} -std=c++0x" -csimflags "-I../libs/Vitis_Libraries/vision/L1/include ${OPENCV_INC_FLAGS} -std=c++0x "
add_files -tb ${project_folder_name}/tb_questionare.cpp -cflags "-I../libs/Vitis_Libraries/vision/L1/include -std=c++0x" -csimflags "-I../libs/Vitis_Libraries/vision/L1/include  -std=c++0x "
...
cosim_design -tool xsim -wave_debug -enable_dataflow_profiling -enable_fifo_sizing -rtl verilog -trace_level all
